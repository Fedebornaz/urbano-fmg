...
const AboutUs = () => {
  return (
    <div
      ...
      id="about-us"
    >
      <h1 className="text-3xl md:text-4xl text-pink-darkest font-bold mt-14">
        ¿Quiénes somos?
      </h1>
      <p className="text-lg mt-16 lg:mt-20 text-justify">
      ...
      <p className="text-lg mt-8 lg:mt-10 text-justify">
