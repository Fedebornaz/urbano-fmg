...
const Contact = () => {
  ...
  return (
    <div
      className="h-screen w-full flex flex-col items-center py-20 px-32 bg-gray-900"
      id="contact"
    >
      <div className="mt-8 w-full h-full flex">
        <div className="bg-white rounded-md w-1/2 h-auto mt-7">
          <form
        ...
        <div className="w-1/2 max-h-full p-14">
